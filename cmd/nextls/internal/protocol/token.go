...
//go:generate go run golang.org/x/tools/cmd/stringer@latest -type=TokenType -linecomment
...
//go:generate go run golang.org/x/tools/cmd/stringer@latest -type=TokenModifier -linecomment
