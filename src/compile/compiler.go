...
func (c *Compiler) SetupCommandFlags(flagSet *flag.FlagSet, u flags.UsageFunc) {
	...
	// @api(CommandLine/Flag/-test) represents the test mode of the compiler.
	...
	//	next -test ...
	//	```
	flagSet.BoolVar(&c.flags.test, "test", false, u(""+
		"Enable test mode for validating but not generating code.\n"+
		"Example:\n"+
		"  next -test ...\n",
	))

	// @api(CommandLine/Flag/-header) represents the header comment for generated code.
	...
	//
	// :::
	flagSet.StringVar(&c.flags.header, "header", "", u(""+
		"Set the header comment for generated code.\n"+
		"Example:\n"+
		"  next -header \"Code generated by Next; DO NOT EDIT.\"\n",
	))

	// @api(CommandLine/Flag/-grammar) represents the custom grammar for the next source code.
	flagSet.StringVar(&c.flags.grammar, "grammar", "", u(""+
