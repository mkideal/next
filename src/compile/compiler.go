...
func (c *Compiler) SetupCommandFlags(flagSet *flag.FlagSet, u flags.UsageFunc) {
	...
	//	next -t ...
	//	```
	flagSet.BoolVar(&c.flags.test, "t", false, u(""+
	...
	//
	// :::
	flagSet.StringVar(&c.flags.head, "head", "", u(""+
	...
	//	:::
	flagSet.StringVar(&c.flags.grammar, "g", "", u(""+
	...
	//	next -s ...
	//	```
	flagSet.BoolVar(&c.flags.strict, "s", false, u(""+
