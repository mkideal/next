...
`.Name` represents the annotation name pattern.
...
`.OffIota` represents the enum member iota value is off or not. If the enum member iota value is off, the enum member iota value is not allowed in the next files.
...
`.OffValueExpr` represents the enum member value expression is off or not. If the enum member value expression is off, the enum member value expression is not allowed in the next files.
