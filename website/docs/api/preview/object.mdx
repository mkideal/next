...
###### .Node {#user-content-Object_Common_Annotation__Node}
<div className="property-container">
...
###### .List {#user-content-Object_Decls__List}
<div className="property-container">

`.List` returns the all top-level declarations.
...
###### .LookupLocalType {#user-content-Object_Package__LookupLocalType}
<div className="property-container">

`.LookupLocalType` looks up a type by name in the package's symbol table.

</div>

###### .LookupLocalValue {#user-content-Object_Package__LookupLocalValue}
<div className="property-container">

`.LookupLocalValue` looks up a value by name in the package's symbol table.
