...
Second, write a Next template file which has extension `.npl` used to conctrol how to generate code for specified language. Here is an example template file used to generate `c++` code.
